...
var CODE_HIGHLIGHT_REGEX, _, delimitCode, extractRows, fallback, formatHeaderSeparator, formatRow, getAttribute, getColumnWidths, indent, indentChildren, insertText, insertTextBefore, isBlock, isTextNode, languageCodeRewrite, ref, ref1, serialize, stringRepeat, treeAdapter,
...
ref = require('./utils'), delimitCode = ref.delimitCode, getAttribute = ref.getAttribute, stringRepeat = ref.stringRepeat, isBlock = ref.isBlock;
