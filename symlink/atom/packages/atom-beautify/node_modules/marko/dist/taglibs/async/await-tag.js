...
function requestData(provider, args, thisObj, timeout) {
    ...
    if (typeof provider === 'function') {
        ...
        if (value !== undefined) {
            asyncValue.bz_(value);
        }
    } else {
        // Assume the provider is a data object...
        asyncValue.bz_(provider);
    }
    ...
    if (timeout > 0) {
        let timeoutId = setTimeout(function () {
            ...
            asyncValue.by_(error);
        }, timeout);

        asyncValue.bx_(function (err, data) {
            if (timeoutId != null) {
...
module.exports = function awaitTag(input, out) {
    ...
    if (clientReorder) {
        ...
        clientReorderContext = out.global.bA_ || (out.global.bA_ = {
            instances: [],
            nextId: 0
        });
