...
function addBubblingEventListener(transformHelper, options) {
    ...
    var addBubblingEventMethod = builder.memberExpression(builder.identifier('__component'), builder.identifier('d'));
...
function addDirectEventListener(transformHelper, options) {
    ...
    var addDomEvent = builder.memberExpression(builder.identifier('__component'), builder.identifier('e'));
    ...
    var helperArgs = [options.eventType, options.targetMethod, componentIdInfo.idExpression, options.isOnce];
