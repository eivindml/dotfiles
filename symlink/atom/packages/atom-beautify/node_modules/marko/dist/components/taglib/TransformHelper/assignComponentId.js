    ...
    if (assignedKey) {
        ...
        if (isCustomTag) {
            ...
            if (context.isServerTarget()) {
                var markoKeyAttrVar = context.importModule('marko_keyAttr', this.getMarkoComponentsRequirePath('marko/components/taglib/helpers/markoKeyAttr'));

                el.setAttributeValue('data-marko-key', builder.functionCall(markoKeyAttrVar, [idExpression, builder.identifier('__component')]));
            }
    ...
    this.componentIdInfo = {
        ...
        createIdVarNode: function () {
            ...
            this.idVarNode = builder.vars([{
                id: idVarName,
                init: builder.functionCall(builder.memberExpression(builder.identifier('__component'), builder.identifier('_h_')), [idExpression])
            }]);
