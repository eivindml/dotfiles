...
function ensure(state, propertyName) {
    ...
    if (!(propertyName in proto)) {
        Object.defineProperty(proto, propertyName, {
            ...
            set: function (value) {
                this.G_(propertyName, value, false /* ensure:false */);
            }
        });
    }
}
...
State.prototype = {
    ...
    E_: function (newState) {
        ...
        for (key in rawState) {
            if (!(key in newState)) {
                state.G_(key, undefined, false /* ensure:false */, false /* forceDirty:false */);
            }
        }

        for (key in newState) {
            state.G_(key, newState[key], true /* ensure:true */, false /* forceDirty:false */);
        }
    },
