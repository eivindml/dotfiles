...
function VElement(tagName, attrs, key, component, childCount, flags, props) {
    ...
    this.au_ = key;
    this._a_ = component;
    this.bk_ = attrs || EMPTY_OBJECT;
    this.ah_ = props || EMPTY_OBJECT;
    this.bl_ = namespaceURI;
    this.an_ = tagName;
    this.bm_ = null;
    this.aw_ = constId;
    this.bn_ = isTextArea;
...
VElement.prototype = {
    ...
    e: function (tagName, attrs, key, component, childCount, flags, props) {
        var child = this.aW_(new VElement(tagName, attrs, key, component, childCount, flags, props));
    ...
    ed: function (tagName, attrs, key, component, childCount, flags, props) {
        var child = this.aW_(VElement.aY_(tagName, attrs, key, component, childCount, flags, props));
    ...
    ao_: function (doc) {
        var namespaceURI = this.bl_;
        var tagName = this.an_;

        var attributes = this.bk_;
        var flags = this._e_;
...
defineProperty(proto, 'ax_', {
    get: function () {
        var value = this.bm_;
        if (value == null) {
            value = this.bk_.value;
        }
        return value != null ? toString(value) : '';
    }
});

VElement.aY_ = function (tagName, attrs, key, component, childCount, flags, props) {
    ...
    element.bl_ = namespace;
    return element;
};

VElement.bp_ = function (attrs) {
...
function virtualizeElement(node, virtualizeChildNodes) {
    ...
    if (node.namespaceURI !== 'http://www.w3.org/1999/xhtml') {
        vdomEl.bl_ = node.namespaceURI;
    }

    if (vdomEl.bn_) {
        vdomEl.bm_ = node.value;
    } else {
...
VElement.al_ = virtualizeElement;

VElement.am_ = function (fromEl, vFromEl, toEl) {
    var removePreservedAttributes = VElement.bp_;
