...
class CodeWriter {
    ...
    writeBlock(body) {
        ...
        if (!body || Array.isArray(body) && body.length === 0 || body instanceof Container && body.length === 0) {
            this.write('{}');
            return;
        }
    ...
    decIndent(count) {
        ...
        this.currentIndent = this.currentIndent.substring(0, this.currentIndent.length - count);
