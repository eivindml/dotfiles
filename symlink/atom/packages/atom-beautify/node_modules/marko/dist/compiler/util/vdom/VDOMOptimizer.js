...
class OptimizerContext {
    ...
    get nextConstIdFunc() {
        ...
        if (!nextConstIdFunc) {
            ...
            nextConstIdFunc = this._nextConstIdFunc = context.addStaticVar('marko_const_nextId', builder.functionCall(constId, [fingerprintLiteral]));
        }
...
class NodeVDOM extends Node {
    ...
    writeCode(writer) {
        ...
        let funcCall = builder.functionCall(builder.identifier('n'), funcCallArgs);
...
function generateNodesForArray(nodes, context, options) {
    ...
    var optimizerContext = context[OPTIMIZER_CONTEXT_KEY] || (context[OPTIMIZER_CONTEXT_KEY] = new OptimizerContext(context));
