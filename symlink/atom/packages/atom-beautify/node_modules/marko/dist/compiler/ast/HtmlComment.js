...
class HtmlComment extends Node {
    ...
    generateHTMLCode(codegen) {
        ...
        return [builder.htmlLiteral('<!--'), builder.html(comment), builder.htmlLiteral('-->')];
    }
    ...
    generateVDOMCode(codegen) {
        ...
        return builder.functionCall(builder.memberExpression(builder.identifierOut(), builder.identifier('comment')), commentArgs);
    }
