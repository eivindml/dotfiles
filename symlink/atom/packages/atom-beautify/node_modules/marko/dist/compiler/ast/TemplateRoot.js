...
class TemplateRoot extends Node {
    ...
    generateCode(codegen) {
        ...
        if (context.inline) {
            ...
            return builder.functionCall(createInlineMarkoTemplateVar, [builder.identifier('__filename'), builder.functionDeclaration(null, renderParams, renderStatements)]);
        } else {
            var createArgs = context.useMeta ? [builder.identifier('__filename')] : [];
