...
class HtmlElementVDOM extends Node {
        ...
        if (hasDynamicAttributes) {
            dynamicAttributes.forEach(attrs => {
                if (attributesArg) {
                    ...
                    attributesArg = builder.functionCall(mergeVar, [attributesArg, // Input props from the attributes take precedence
                    attrs]);
                } else {
                    attributesArg = attrs;
                }
    ...
    writeCode(writer) {
        ...
        if (this.isChild) {
            ...
            funcCall = builder.functionCall(builder.identifier(this.isLiteralTag || this.isSVG ? 'e' : 'ed'), createArgs);
            ...
            writer.write('out.');
            funcCall = builder.functionCall(builder.identifier(this.isLiteralTag || this.isSVG ? 'be' : 'bed'), createArgs);
        }
